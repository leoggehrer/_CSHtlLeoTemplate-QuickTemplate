...
namespace QuickTemplate.Logic.Facades.Account
{
    ...
    public sealed partial class UsersFacade : FacadeObject, Contracts.Account.IUsersAccess<TModel>
    {
        ...
        public UsersFacade()
        : base(new QuickTemplate.Logic.Controllers.Account.UsersController())
        {
            Constructing();
            Constructed();
        }
        public UsersFacade(FacadeObject facadeObject)
        : base(new QuickTemplate.Logic.Controllers.Account.UsersController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
