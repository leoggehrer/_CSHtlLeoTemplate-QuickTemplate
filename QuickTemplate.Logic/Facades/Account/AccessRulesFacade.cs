...
namespace QuickTemplate.Logic.Facades.Account
{
    ...
    public sealed partial class AccessRulesFacade : FacadeObject, Contracts.Account.IAccessRulesAccess<TModel>
    {
        private Contracts.Account.IAccessRulesAccess<TEntity> Controller => (ControllerObject as Contracts.Account.IAccessRulesAccess<TEntity>)!;
