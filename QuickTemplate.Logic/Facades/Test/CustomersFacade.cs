//@GeneratedCode
namespace QuickTemplate.Logic.Facades.Test
{
    using TModel = Models.Test.Customer;
    using TEntity = Entities.Test.Customer;
    using System;
    public sealed partial class CustomersFacade : FacadeObject, Contracts.Test.ICustomersAccess<TModel>
    {
        private Contracts.Test.ICustomersAccess<TEntity> Controller => (ControllerObject as Contracts.Test.ICustomersAccess<TEntity>)!;
#if ACCOUNT_ON
        ...
        : base(new QuickTemplate.Logic.Controllers.Test.CustomersController())
        {
            Constructing();
            Constructed();
        }
        public CustomersFacade(FacadeObject facadeObject)
        : base(new QuickTemplate.Logic.Controllers.Test.CustomersController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
