...
{
    using TModel = Models.Test.Company;
    using TEntity = Entities.Test.Company;
    using System;
    public sealed partial class CompaniesFacade : FacadeObject, Contracts.Test.ICompaniesAccess<TModel>
    {
        private Contracts.Test.ICompaniesAccess<TEntity> Controller => (ControllerObject as Contracts.Test.ICompaniesAccess<TEntity>)!;
#if ACCOUNT_ON
        ...
        : base(new QuickTemplate.Logic.Controllers.Test.CompaniesController())
        {
            Constructing();
            Constructed();
        }
        public CompaniesFacade(FacadeObject facadeObject)
        : base(new QuickTemplate.Logic.Controllers.Test.CompaniesController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
