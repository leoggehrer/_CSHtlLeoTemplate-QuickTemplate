...
namespace TemplateCodeGenerator.Logic.Generation
{
    internal partial class ItemProperties
    {
        ...
        {
            return Path.Combine(CreateContractSubNamespace(type).Replace(".", "\\"), $"{CreateServiceContractName(type)}{postFix}{fileExtension}");
        }
        ...
        {
            return Path.Combine(CreateControllerSubNamespace(type).Replace(".", "\\"), $"{CreateControllerClassName(type)}{postFix}{fileExtension}");
        }
        ...
        {
            return Path.Combine(CreateServiceSubNamespace(type).Replace(".", "\\"), $"{CreateServiceClassName(type)}{postFix}{fileExtension}");
        }
        ...
        {
            return Path.Combine(CreateFacadeSubNamespace(type).Replace(".", "\\"), $"{CreateFactoryFacadeMethodName(type)}{postFix}{fileExtension}");
        }
