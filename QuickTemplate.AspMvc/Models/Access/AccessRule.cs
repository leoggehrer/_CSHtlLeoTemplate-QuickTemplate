...
namespace QuickTemplate.AspMvc.Models.Access
{
    ...
    public partial class AccessRule : VersionModel
    {
        ...
        /// Generated by the generator
        ///
        public static QuickTemplate.AspMvc.Models.Access.AccessRule Create()
        {
            BeforeCreate();
            var result = new QuickTemplate.AspMvc.Models.Access.AccessRule();
            AfterCreate(result);
            return result;
        }
        ///
        /// Generated by the generator
        ///
        public static QuickTemplate.AspMvc.Models.Access.AccessRule Create(object other)
        {
            BeforeCreate(other);
            var result = new QuickTemplate.AspMvc.Models.Access.AccessRule();
        ...
        static partial void AfterCreate(QuickTemplate.AspMvc.Models.Access.AccessRule instance);
        static partial void BeforeCreate(object other);
        static partial void AfterCreate(QuickTemplate.AspMvc.Models.Access.AccessRule instance, object other);
        ///
        /// Generated by the generator
        ///
        public void CopyProperties(QuickTemplate.AspMvc.Models.Access.AccessRule other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(QuickTemplate.AspMvc.Models.Access.AccessRule other, ref bool handled);
        partial void AfterCopyProperties(QuickTemplate.AspMvc.Models.Access.AccessRule other);
        ///
        /// Generated by the generator
        ///
