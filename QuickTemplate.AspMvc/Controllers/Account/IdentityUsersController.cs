...
{
    using TAccessModel = QuickTemplate.Logic.Models.Account.User;
    using TViewModel = QuickTemplate.AspMvc.Models.Account.IdentityUser;
    using TFilterModel = QuickTemplate.AspMvc.Models.Account.IdentityUserFilter;
    using TAccessContract = QuickTemplate.Logic.Contracts.Account.IUsersAccess<QuickTemplate.Logic.Models.Account.User>;
