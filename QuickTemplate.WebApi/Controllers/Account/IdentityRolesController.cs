...
namespace QuickTemplate.WebApi.Controllers.Account
{
    ...
    using TEditModel = QuickTemplate.WebApi.Models.Account.IdentityRoleEdit;
    using TOutModel = QuickTemplate.WebApi.Models.Account.IdentityRole;
    ///
    ...
    public sealed partial class IdentityRolesController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public IdentityRolesController(QuickTemplate.Logic.Contracts.Account.IRolesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
