...
namespace QuickTemplate.WebApi.Controllers.Account
{
    ...
    using TEditModel = QuickTemplate.WebApi.Models.Account.AccessRoleEdit;
    using TOutModel = QuickTemplate.WebApi.Models.Account.AccessRole;
    ///
    ...
    public sealed partial class AccessRolesController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public AccessRolesController(QuickTemplate.Logic.Contracts.Account.IRolesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
