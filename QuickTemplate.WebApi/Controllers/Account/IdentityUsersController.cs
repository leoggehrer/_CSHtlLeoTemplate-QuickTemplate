...
namespace QuickTemplate.WebApi.Controllers.Account
{
    ...
    using TEditModel = QuickTemplate.WebApi.Models.Account.IdentityUserEdit;
    using TOutModel = QuickTemplate.WebApi.Models.Account.IdentityUser;
    ///
    ...
    public sealed partial class IdentityUsersController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public IdentityUsersController(QuickTemplate.Logic.Contracts.Account.IUsersAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
